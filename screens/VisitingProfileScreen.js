...
const VisitingProfileScreen = ({route, navigation}) => {
    const {name, photoUrl, displayName} = route.params;
    console.log(photoUrl);
     //context
    const {storedCredentials, setStoredCredentials} = useContext(CredentialsContext);
    const AvatarImg = devModeOn? photoUrl ? photoUrl : require('./../assets/img/Logo.png') : photoUrl ? {uri: photoUrl} : require('./../assets/img/Logo.png');
                ...
                <ScrollView showsVerticalScrollIndicator={false} scrollEnabled={!PageElementsState}>
                    <WelcomeContainer style={{backgroundColor: colors.primary}}>
                        ...
                        <ProfInfoAreaImage>
                            ...
                            <PageTitle welcome={true}>{displayName || name || "Couldn't get name, visiting"}</PageTitle>
...
export default VisitingProfileScreen;
