...
const EditPostScreenBackgroundColor = ({navigation, route}) => {
    ...
    return (
        <>
            ...
            <ProfileOptionsView style={{backgroundColor: primary, height: '80%', paddingBottom: 20}} viewHidden={InfoPageIsHidden}>
                ...
                <ScrollView>
                    <ColourInformationText titleText="Background Color" text="This is the background colour for the post screen"/>
                    <ColourInformationText titleText="Status Bar Color" text="This is the system status bar color for when you are on this screen (clock, WiFi strength etc.). This can only be light or dark."/>
                </ScrollView>
                <View style={{width: '100%', backgroundColor: borderColor, minHeight: 1, maxHeight: 1}}/>
            </ProfileOptionsView>
            <ChatScreen_Title style={{backgroundColor: primary, borderWidth: 0}}>
                ...
                <TestText style={{textAlign: 'center', color: tertiary}}>Post Screen</TestText>
                {
...
export default EditPostScreenBackgroundColor;