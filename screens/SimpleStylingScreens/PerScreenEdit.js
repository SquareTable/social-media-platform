        ...
        <>
            ...
            <ProfileOptionsView style={{backgroundColor: primary, height: '80%', paddingBottom: 20}} viewHidden={InfoPageIsHidden}>
                ...
                <ScrollView>
                    ...
                    <ColourInformationText titleText="Bottom Navigation Bar" text="This is the bottom navigation bar at the bottom of the screen. You can change the colour of the images and text, and background colour of the nav bar."/>
                    <ColourInformationText titleText="Post Views" text="This is all of teh screens that show posts such as audio, photo, thread, and more types of posts."/>
                </ScrollView>
                <View style={{width: '100%', backgroundColor: borderColor, minHeight: 1, maxHeight: 1}}/>
            </ProfileOptionsView>
                ...
                {InfoPageIsHidden == true ?
                    <ScrollView style={{height: '100%'}} contentContainerStyle={{alignItems: 'center', backgroundColor: primary}}>
                        ...
                        <TouchableOpacity style={{justifyContent: 'center', borderColor: borderColor, borderWidth: 3, marginVertical: 10, borderRadius: 50, padding: 20, width: '90%'}} onPress={() => {
                            ...
                            <Text style={{fontSize: 20, color: tertiary, fontWeight: 'bold', textAlign: 'center'}}>Bottom Navigation Bar</Text>
                        </TouchableOpacity>
                        ...
                        <TouchableOpacity style={{justifyContent: 'center', borderColor: borderColor, borderWidth: 3, marginVertical: 10, borderRadius: 50, padding: 20, width: '90%'}} onPress={() => {
                            ...
                            <Text style={{fontSize: 20, color: tertiary, fontWeight: 'bold', textAlign: 'center'}}>Post Views</Text>
                        </TouchableOpacity>
