...
const AppStyling = ({navigation}) => {
    ...
    useEffect(() => {
        if (allowedToChangeStyle.current == false) {
            allowedToChangeStyle.current = true;
        }
