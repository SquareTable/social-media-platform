...
const App = () => {
  ...
  var development_version = '0.1.01';
  const getData = async () => {
    try {
      ...
      if(development_version_localstorage_value !== null) {
        if (development_version !== development_version_localstorage_value) {
          ...
          var releaseNotes = "MAJOR UPDATE: Added post screen, 3 different upload screens inside of the post screen, add display names for accounts, and also change email, username, password, display name screens in Profile Settings, and more report options";
